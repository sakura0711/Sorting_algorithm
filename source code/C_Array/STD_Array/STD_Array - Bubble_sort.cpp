...
void Print_Time(double TimeAdd, int i, string TypeKeys) {
    fstream outfile;
    outfile.open("C:\\Users\\MSI GP65\\source\\repos\\Data_structure - 排序法\\Sort - CostTime\\Time - STD_Array-Bubble_sort.txt", ios::app);
    if (TimeAdd < 1000)
    {
        outfile << "\n"
            << "(" << TypeKeys << ")"
...
void Bubble_sort(array<T, nSize>* pData, string TypeKeys) noexcept
{
